...
def main():
    ...
    parser.add_argument("-s", "--show", type=str, nargs=1,
                        ...
                        help="Shows all the text files on specicified directory path.\
    ...
    parser.add_argument("-c", "--copy", type=str, nargs=2,
                        metavar=('file1','file2'), help="Copy file1 contents \
                            to file2. Warning: file2 will get overwritten.")
    ...
    # call functions depending on type of arg
    if args.read != None:
        read(args)
    elif args.show != None:
        show(args)
